        ...
        <section className='sectionDetail'>
            <div className='sectionContainer'>
                <div className='imgContainer'>
                    <img className='detailImg' src={data.img} alt='Foto Gamer'></img>
                </div>
                <div className='detailContainer'>
                    ...
                    <p className='detailStock'> Ultimas: {data.stock} unidades</p>
                    <Link  className='link-categoria' to={`/category/${data.category}`}>Volver a: {data.category}</Link>
